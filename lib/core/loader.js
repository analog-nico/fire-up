...
function newLoader(fireUp) {
  ...
  function validateBasePath(options) {
    ...
    if (_.isString(options.basePath) === false || options.basePath.length === 0) {
      ...
      // TODO: Explain purpose of basePath
    }
      ...
      for ( var k = 0; k < interfaces.length; k+=1 ) {
        ...
        for ( var p = 0; p < interfaceChain.length; p+=1 ) {
          ...
          if (p === interfaceChain.length-1) {
            ...
            fireUp.log.info('Registered module at \'' + filePathRelativeToCwd + '\' as implementation for interface \'' + currentInterface + '\'.');
          }
          ...
          .then(function (modules) {
            return new Promise(function (resolve) {
              ...
              try {
                ...
                fireUp.log.debug('All dependencies were initialized and injected. Hence the error occurred in the factory method of \'' + interfaceRecord.file + '\'.');
                throw initErr;
              }
            })
