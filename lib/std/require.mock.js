...
// FIXME: If requireMockMapping is defined in options but use does not contain 'require:mock' throw error
// FIXME: E.g. requireMockMapping = { 'assumejs': 'mocks/assumejs' }; The mock requests 'require(assumejs)' to be injected. -> Deadlock
