...
function NoImplementationError(injectionRequest) {
  ...
  this.moduleReference = injectionRequest.moduleReference;
...
function InstanceInitializationError(injectionRequest, moduleFile, thrownError) {
  ...
  this.message = util.format("An error occurred while creating an instance for '%s': %s", injectionRequest.moduleReference, thrownError.message);
  this.moduleReference = injectionRequest.moduleReference;
  this.moduleFile = moduleFile;
  this.thrownError = thrownError;
  this.injectionRequest = injectionRequest;
